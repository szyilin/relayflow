...
public enum ErrorCodeConstants implements ErrorCode {
    ...
    AUTH_REGISTER_DISABLED(1_001_001_003, "开放注册未启用"),
    AUTH_NO_TENANT(1_001_001_004, "无可登录的企业"),
    USER_NOT_FOUND(1_001_002_001, "用户不存在"),
    USER_USERNAME_EXISTS(1_001_002_002, "用户名已存在"),
    USER_DEPT_REQUIRED(1_001_002_003, "主部门不能为空"),
    USER_ALREADY_MEMBER(1_001_002_004, "该用户已是本组织成员"),
    ...
    SEARCH_KEYWORD_REQUIRED(1_001_002_010, "请输入搜索关键词"),
    USER_PREFERENCE_INVALID(1_001_002_011, "用户偏好参数非法"),
    ...
    TENANT_SWITCH_FORBIDDEN(1_001_003_004, "无权切换到该企业"),
