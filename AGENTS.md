...
**下一优先**：[`workspace-task-list-board-v1`](openspec/changes/workspace-task-list-board-v1/proposal.md)（清单 → 看板，前端优先子切片）；其次 `/app/docs` 占位产品化，或 `bpm-v1`（deferred）。日历 / 任务核心 / 前端工程硬化已归档。
