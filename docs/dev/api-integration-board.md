...
| **workspace-task-board** | **ready** | **ui_ready** | status 三态 · `PUT …/board-move` · `/app/tasks` 看板 | [contract](../../openspec/lanes/workspace-task-board/contract.md) | 母 change；P1；待 integrate 关 `USE_LOCAL_BOARD_MOVE` |
